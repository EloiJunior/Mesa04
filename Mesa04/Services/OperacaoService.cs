...
namespace Mesa04.Services
{
    public class OperacaoService
    {
        ...
        */
        ...
        public async Task InsertAsync(/*[Bind("Id,Data,Valor,Taxa,Despesa,Fluxo,Banco,OperacaoStatus")]*/ Operacao operacao)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task UpdateAsync(/*int id, [Bind("Id,Data,Valor,Taxa,Despesa,Fluxo,Banco,OperacaoStatus")]*/ Operacao operacao)
        {
